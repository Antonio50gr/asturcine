  ...
  <script type="text/javascript">
    $(document).on('ready', function() {
      ...
      $(".regular").slick({
        ...
        <div class="card">
  <div class="card_left">
  @if(!empty($informacionserieArray['poster_path']))
  <img src="https://image.tmdb.org/t/p/w300{{$informacionserieArray['poster_path']}}" class="card-img-top" alt="...">
  @else  
  <img src="{{ asset('images/logo.PNG') }}" >
  @endif
  </div>
          <div class="card_right">
              <h1 class="titulo-pelicula"> {{$informacionserieArray['name']}}</h1>
            <div class="card_right__details">
                <ul>
                  <li>Fecha de estreno: {{$informacionserieArray['first_air_date']}}</li>
                  <li>Nº capítulos: {{$informacionserieArray['number_of_episodes']}}</li>
                </ul>
              ...
              @if (Auth::check())
                ...
                @endif
                <div class="biografia">
                  <p class="card-text">{{$informacionserieArray['overview']}}</p>
                </div>
              </div>
        ...
        <div class="sliders-container">
          <section class="regular slider">
            ...
            @if($informacionsimilar['poster_path'])
              <a href="{{ route('informacion.infoseries',['codigo'=>$informacionsimilar['id']]) }}">
              ...
              <div class="post-comment padding-top40">
                ...
                <form action="{{route('comentario.store')}}" role="form">
                  ...
                  <div class="form-group"> 
                    ...
                    <input type="hidden" name="pelicula_id" value="{{$informacionserieArray['id']}}">
                  </div>
